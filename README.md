...
- NetCDF satellite data ingestion not yet implemented.
- Limited mobile responsiveness for certain UI components.
- AI outputs are not scientifically peer-reviewed — intended for informational purposes only.
- Geographic coverage currently limited to demonstration sites.

---

## 🛠 Future Improvements

- Direct Copernicus NetCDF integration
- Predictive HAB modelling
- Automated real-time data ingestion
- Mobile-first responsive UI
- User authentication and saved queries
- Advanced export options (GeoJSON, Excel)
...
## 👥 Contributors
- **Shikhar Singh Negi** — Backend, LLM Integration, Data Migration
- **Khush Sushil Poddar** — Frontend Development
- **Harshal Chandrakant More** — UI/UX and Mapping
- **Anuj Lalitkumar Lamba** — Data Pipeline
- **Omkar Sanwatsarkar** — Testing & Documentation
