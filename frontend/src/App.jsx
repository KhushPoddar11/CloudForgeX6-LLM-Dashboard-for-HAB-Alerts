...
export default function App() {
  ...
  const fetchMeasurements = async () => {
    setLoading(true);
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/measurements`, {
        site: selectedSite,
        start_date: startDate,
        end_date: endDate,
        limit: dataLimit
  ...
  const fetchSiteStats = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/sites/${selectedSite}/stats`, {
        params: {
          start_date: startDate,
          end_date: endDate
        }
  ...
  const askLLM = async () => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/ask-llm`, {
        site: selectedSite,
        start_date: startDate,
        end_date: endDate,
        user_question: question,
